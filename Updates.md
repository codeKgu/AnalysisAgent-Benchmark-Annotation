...
1. **Should I record all the models I try or only the final models?**
...
2. **How should I specify alternatives if there are many combinations of reasonable transformations?**
...
3. **How do I handle a conceptual variable that maps to multiple columns in the data?**
...
4. **What are the guidelines for naming conceptual variables?**
